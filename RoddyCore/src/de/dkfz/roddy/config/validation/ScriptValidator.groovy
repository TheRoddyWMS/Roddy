...
class ScriptValidator extends ConfigurationValidator {
    ...
    boolean validateVariableUsageInFile(File f, String toolID) {
    ...
    boolean validateScriptAvailability() {
...
//        Collection<File> calledToolPathsOriginalList = new LinkedList<>(calledToolPaths);
    ...
    ScriptChecker getScriptCheckerForFile(File f, String toolID) {
    ...
    @Override
    boolean performRuntimeChecks() {
        return validateScriptAccessibility()
    }

    boolean validateScriptAccessibility() {
        return true
    }
}
