...
class ConfigurationValueCombinationValidator extends ConfigurationValidator {
    ...
    boolean validate() {
        ...
        //Check group wise. At least one value in the group has to be valid. If this is the case, the whole group is valid.
