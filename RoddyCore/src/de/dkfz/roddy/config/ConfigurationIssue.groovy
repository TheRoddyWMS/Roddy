...
class ConfigurationIssue {
    ...
    static enum ConfigurationIssueTemplate {
        ...
        malformedVariableExpression(
                ConfigurationIssueLevel.CVALUE_WARNING,
                "Variables in your configuration appear to misuse variable references. For variable references, nesting '\${\${innerVar}}' is forbidden.",
                "Variable '#REPLACE_0#' defined in '#REPLACE_1#' may use malformed variable references. For variables references, nesting '\${\${innerVar}}' is forbidden."
        )
