...
public class FileObjectTupleFactory {
    ...
    public static <X extends FileObject, Y extends FileObject> AbstractFileObjectTuple createTuple(List<FileObject> fileObjects) {
        ...
        if (fileObjects.size() == 2) {
            ...
            return new Tuple13<>(
                    fileObjects[0], fileObjects[1], fileObjects[2], fileObjects[3], fileObjects[4],
                    fileObjects[5], fileObjects[6], fileObjects[7], fileObjects[8], fileObjects[9],
                    fileObjects[10], fileObjects[11], fileObjects[12]
            );
        }
    }
