...
class DefaultValidatorSpec extends Specification {
    ...
    def "test check proper dollar sign usage in variables"(value, expected, expectedWarnings, expectedErrors) {
        when:
        ConfigurationValue cval = new ConfigurationValue("bla", value)
        ...
        where:
        value                     | expected | expectedWarnings                                           | expectedErrors
        "abc\${var}bcd\${var}"    | true     | []                                                         | []
        "abc\${var}bcd\${var}def" | true     | []                                                         | []
        "abc\$"                   | true     | []                                                         | []
        "abc\${"                  | false    | [new ConfigurationIssue(unattachedDollarCharacter, "bla")] | []
