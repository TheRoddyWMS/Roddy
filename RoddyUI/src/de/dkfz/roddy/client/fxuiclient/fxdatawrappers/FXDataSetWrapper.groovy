...
//            isExecutable = workflow.checkExecutability(new ExecutionContext(FileSystemAccessProvider.getInstance().callWhoAmI(), analysis, ds, ExecutionContextLevel.QUERY_STATUS, ds.getOutputFolde(analysis), ds.getInputFolder(analysis), null, -1, true));
//        }
//        return isExecutable;
//    }
