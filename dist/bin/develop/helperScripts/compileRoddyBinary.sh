...
${GROOVY_BINARY:-groovy} ${SCRIPTS_DIR:-.}/IncreaseAndSetBuildVersion.groovy RoddyCore/buildversion.txt RoddyCore/src/de/dkfz/roddy/Constants.java ${INCREASE_BUILD_VERSION:-true}
